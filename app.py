...
with gr.Blocks(theme=gr.themes.Soft(), title="Target y Predictor") as demo:
    ...
    gr.Markdown("---")
    gr.Markdown("### Research Notes & Findings: https://precious-columnist-a00.notion.site/Time-Series-Forecasting-for-SONY-Stocks-Closing-prices-3e4f4ed388e280cb8559d0cda029f77d")
